...
{
    public static class BlogsGenerator
    {
        public static async Task GenerateBlogsAsync
            (AppDbContext context,UserManager<User>userManager)
        {
            User vahidUser = await userManager.FindByNameAsync("vahiduser");
            User nurlanUser = await userManager.FindByNameAsync("nurlanUser");
